...
1. En Google Colab abrimos un cuaderno nuevo para empezar a instalar las librerías que no teníamos necesitadas para el código.
...
Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.003.png)

Figura #3. Importación de librerías.

1. ![](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.004.png)Del archivo csv que contiene los datos de una nivelación leemos los datos y los convertimos en un arreglo.

Figura #4. Lectura del archivo csv y arreglo de datos.

1. Obtenemos la cota del puto de liga, la altura de aparato y calculamos el desnivel.

![Texto

Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.005.png)

Figura #5. Calculo de la cota, altura del aparato y desnivel

![Texto

Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.006.png)

Figura #6. Resultado del código para la obtención del desnivel, cota y altura de instrumento. 

1. Importamos librerías requeridas para un nuevo proceso. 

![Texto

Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.007.png)

Figura #7 Importación de librerías.

1. Procesamos coordenadas para poderlas representar en un mapa.

![Texto

Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.008.png)

Figura #8. Procesamiento de coordenadas para la obtención de un mapa

![](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.009.png)
...
![Ejemplo de serie](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.011.png)
...
- ![](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.012.png)Series (data=diccionario, index=indices): Devuelve un objeto de tipo Series con los valores del diccionario diccionario y las filas especificadas en la lista indices. Si no se pasa la lista de índices se utilizan como índices las claves del diccionario.
...
Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.013.png)

Figura #10. Código que utiliza la librería Folium.

![Mapa

Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.014.png)
...
Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.015.png)
...
Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.016.png)
...
Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.018.png)
...
Descripción generada automáticamente con confianza baja](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.019.png)
...
Descripción generada automáticamente](Aspose.Words.28664117-5689-49a4-8ca2-d6dab88f2dc9.020.png)
